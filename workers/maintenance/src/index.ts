...
import { bootstrapWorker, closeRedisConnection } from "@ai-marketing-manager/queue";
import { loadWorkerEnv } from "./env.js";
import { createMaintenanceProcessor } from "./processor.js";
...
async function main() {
  ...
  const { shutdown, isReady } = bootstrapWorker({
    ...
    logger,
    processor: createMaintenanceProcessor(logger),
