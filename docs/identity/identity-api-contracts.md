...
**Document ID:** IDENT-011 | Version 1.2 | Status: Approved (Owner Decision, 2026-09-05); member-management + invite rows annotated as implemented Phase 2.5 (2026-09-10) | Phase: 2A (Architecture Finalization)
